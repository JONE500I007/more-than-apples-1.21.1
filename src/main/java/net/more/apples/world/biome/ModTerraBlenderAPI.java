...
import net.more.apples.world.biome.biomes_regions.ancient_apple.AncientAppleRegion;
...
import net.more.apples.world.biome.biomes_regions.scorched_apple.ScorchedAppleRegion;
...
public class ModTerraBlenderAPI implements TerraBlenderApi {
    ...
    public void onTerraBlenderInitialized() {
        ...
        Regions.register(new AncientAppleRegion(Identifier.fromNamespaceAndPath(MoreThanApples.MOD_ID, "ancient_apple_wilds"), 5));

        //Regions.register(new ScorchedAppleRegion(Identifier.fromNamespaceAndPath(MoreThanApples.MOD_ID, "scorched_apple_badlands"), 5));
