package net.more.apples.world.biome.biomes_regions.scorched_apple;
...
public class ScorchedAppleBiome {
    public static final ResourceKey<Biome> SCORCHED_APPLE_BADLANDS = ResourceKey.create(Registries.BIOME,
            Identifier.fromNamespaceAndPath(MoreThanApples.MOD_ID, "scorched_apple_badlands"));

    public static void boostrap(BootstrapContext<Biome> context) {
        context.register(SCORCHED_APPLE_BADLANDS, applegBiome(context));
    }
    ...
    public static Biome applegBiome(BootstrapContext<Biome> context) {
        ...
        //spawnBuilder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(EntityTypes.WOLF, 5, 4, 4));
        ...
        spawnBuilder.addSpawn(EntityTypes.HUSK, 95, 1, 4);
...
//                AquaticPlacements.SEAGRASS_RIVER);
        ...
        return new Biome.BiomeBuilder()
                ...
                .setAttribute(EnvironmentAttributes.SKY_COLOR, ARGB.vector3fFromRGB24(0x72A4FF))
                .setAttribute(EnvironmentAttributes.FOG_COLOR, ARGB.vector3fFromRGB24(0xE9B84D))
                .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, ARGB.vector3fFromRGB24(0x7B6044))
