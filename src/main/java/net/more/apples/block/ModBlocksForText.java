...
public class ModBlocksForText {
    ...
    public static final Block FRUIT_APPLE_LEAVES_TEST44 = registerBlock("fruit_apple_leaves_test44",
            new LeavesBlock(AbstractBlock.Settings
                    .copy(Blocks.OAK_LEAVES)
                    .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(MoreThanApples.MOD_ID, "fruit_apple_leaves_test44")))));
