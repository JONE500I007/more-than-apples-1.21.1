...
import net.more.apples.datagen.recipe.apple.AppleRecipes;
import net.more.apples.datagen.recipe.frosty.FrostyRecipes;
import net.more.apples.datagen.recipe.test.TestAppleRecipes;
