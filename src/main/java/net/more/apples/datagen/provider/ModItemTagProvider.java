...
import net.more.apples.datagen.tag.apple.AppleTags;
import net.more.apples.datagen.tag.frosty.FrostyTags;
import net.more.apples.datagen.tag.test.TestAppleTags;
