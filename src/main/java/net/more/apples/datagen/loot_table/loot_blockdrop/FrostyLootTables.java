...
public final class FrostyLootTables {
    private FrostyLootTables() {
    }
    ...
    public static void addLoot(ModLootBlockDrop provider) {
        ...
        provider.addWallSignLoot(FrostyAppleWoodVariants.FROSTY_APPLE_WALL_SIGN, FrostyAppleWoodVariants.FROSTY_APPLE_STANDING_SIGN);
        provider.drop(FrostyAppleWoodVariants.FROSTY_APPLE_HANGING_SIGN_BLOCK);
        provider.addWallHangingSignLoot(FrostyAppleWoodVariants.FROSTY_APPLE_WALL_HANGING_SIGN, FrostyAppleWoodVariants.FROSTY_APPLE_HANGING_SIGN_BLOCK);
    }
}
