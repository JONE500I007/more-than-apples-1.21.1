...
public final class FrostyAppleRecipes {
    private FrostyAppleRecipes() {
    }
    ...
    public static final BlockFamily FROSTY_APPLE_WOOD_FAMILY = BlockFamilies.familyBuilder(FrostyAppleWoodBlocks.FROSTY_APPLE_PLANKS)
            ...
            .strippedLog(FrostyAppleWoodBlocks.STRIPPED_FROSTY_APPLE_LOG)
            .hangingSign(FrostyAppleWoodVariants.FROSTY_APPLE_HANGING_SIGN_BLOCK, FrostyAppleWoodVariants.FROSTY_APPLE_WALL_HANGING_SIGN)
